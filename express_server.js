// ---importing packages/ setting the PORT.
...
app.use(
  cookieSession({
    name: "session",
    keys: [
      "B&E)H@McQfTjWnZr4t7w!z%C*F-JaNdR",
      "!A%D*G-KaPdSgUkXp2s5v8y/B?E(H+Mb",
    ],
  })
);
...
// ---Randomizing characters for the shortened URL
...
// ---Declaring urlDatabase and users objects.
const urlDatabase = {
  b6UTxQ: {
...
app.get("/urls/:shortURL", (req, res) => {
  ...
  if (req.session.user_id === urlDatabase[templateVars.shortURL].userID) {
    ...
    res
      .status(400)
      .send("Access Denied: The link does not belong to this user.");
  }
});
